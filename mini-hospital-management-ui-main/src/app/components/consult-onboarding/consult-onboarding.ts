...
@Component({
  selector: 'app-consult-onboarding',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './consult-onboarding.html',
  styleUrl: './consult-onboarding.css'
})
export class ConsultOnboarding {
  form!: FormGroup;
  userId!: string;
  error = '';
  loading = false;
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      specialty: ['Consultant', Validators.required],
      phone: [''],
